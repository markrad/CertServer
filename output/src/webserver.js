                ...
                try {
                    ...
                    if (c) {
                        if (request.body.intPassword) {
                            k = node_forge_1.pki.decryptRsaPrivateKey(yield (0, promises_1.readFile)(path_1.default.join(this._privatekeysPath, kRow.name + '.pem'), { encoding: 'utf8' }), request.body.intPassword);
                        }
                        else {
